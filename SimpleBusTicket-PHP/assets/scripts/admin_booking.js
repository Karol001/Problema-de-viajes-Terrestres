...
function showRouteSuggestions(evt)
{
  ...
  .map(({route_id, route_cities, route_dep_date, route_dep_time, }) => {
    ...
    return `<li id="routeSugg" data-id='${route_id}' data-deptiming='${route_dep_date}, ${route_dep_time}' >
      ...
      <td colspan="10">
          <form class="editRouteForm d-flex justify-content-between" action="${evt.target.dataset.link}" method="POST">
              ...
              <div class="d-flex justify-content-between">
                  <button type="submit" class="btn btn-success btn-sm" name="edit">Editar</button>
