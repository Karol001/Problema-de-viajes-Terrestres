        ...
        <!-- Seats Diagram -->
                ...
                <table class="seatsDiagram">
                    ...
                    <tr>
                        ...
                        <td class="seat-39" data-name="39">39</td>
                        <td class="seat-40" data-name="40">40</td>
                    </tr>
                </table>
                ...
                <div class="customer-details">
                    <div class="form-continued">
                        ...
                        <div>
                            <input type="text" name="seat_selected" placeholder="Número de asiento*" readonly>
                        </div>
                        ...
                        <button class="book-btn" type="submit" name="book">Reserva</button>
                    </div>
                </div>
