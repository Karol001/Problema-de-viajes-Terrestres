...
?>
    ...
    <main id="container">
        <div id="sidebar">
            <h4><i class="fas fa-bus"></i> SDB</h4>
            <div>
            ...
            <ul id="options">
                <li class="option <?php if($page=='index1'){ echo 'active';}?>"> 
                    <a href="./index1.php">
                ...
                <li class="option <?php if($page=='signup'){ echo 'active';}?>">
                    <a href="./signup.php">
                    <i class="fas fa-user-lock"></i> Añade nuevo usuario      
                    </a>
                </li>
            </ul>
        </div>
                ...
                <ul>
                    ...
                    <li class="welcome-item">
                        <button id="logout" class="btn-sm">
                            <a href="../assets/partials/_logout.php">Cerrar sesion</a>
                        </button>
                    </li>
                </ul>
            </section>