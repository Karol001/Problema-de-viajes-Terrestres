        ...
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                    ...
                    <p>
                        <em><b>Fecha reserva:</b> <br><?php echo $booked_timing; ?></em>
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="text-center">
                    <h4><b>Código:</b> <?php echo $pnr; ?></h5>
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Nombre:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Contacto:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Ruta:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Número de bus:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Asiento:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Fecha de viaje:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Hora de viaje:</b></em></h4></td>
