<?php 
    ...
    if(!$booking_exists)
    {
        ...
        $sql = "INSERT INTO `bookings` (`customer_id`, `route_id`, `customer_route`, `booked_seat`, `booking_created`) VALUES ('$customer_id', '$route_id','$customer_route', '$customer_seat', current_timestamp());";
        echo $sql;
