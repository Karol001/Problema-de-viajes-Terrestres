...
<body>
    ...
    <main id="container">
        <section id="searched-route">
            <ul>
                <li class="searched-route-item" id="">Resultados : <span id="result-num">
                    <?php 
                        echo $count;
                    ?>
                </span></li>
            ...
            {?>
                <div class="container mt-4">
                    <div id="noRoutes" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">No existen rutas</h1>
                        <p class="fw-light">
                        Actualmente no hay servicios para la ruta especificada
                        </p>
                        <hr>
                ...
                <div class="searched-container">
                    <div class="searched-result-item">
                        ...
                        <div class="booking-desc">
                            ...
                            echo $bus_no;?>" data-seats="<?php echo $booked_seats; ?>" data-routeid="<?php echo $route_id; ?>" <?php ?>" data-source="<?php echo $source; ?>" data-destination="<?php echo $destination; ?>">
