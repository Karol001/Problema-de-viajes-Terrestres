...
<body>
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["pnr-search"]))
    {
        ...
        if($num)
        {
            ...
            <h4 class="alert-heading">Información de reserva!</h4>
            <p>
            ...
            <hr>
                <p class="mb-0">
                    <ul class="pnr-details">
                        ...
                        <li>
                            <strong>Hora de viaje : </strong>
                            <?php echo $dep_time; ?>
                        </li>
                        <li>
                            <strong>Fecha, Hora de reserva : </strong>
    ...
    <?php }
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["deleteBtn"]))
        {
            ...
            $deleteSql = "DELETE FROM `bookings` WHERE `bookings`.`booking_id` = '$pnr'";
                ...
                if(!$rowsAffected)
                {
                    $messageInfo = "No existen datos";
                }

                elseif($deleteResult)
                {   
                    $messageStatus = "Correcto";
                    $messageInfo = "Reserva eliminada";
    ...
    <header>
        <nav>
            <div>
                    <a href="#" class="nav-item nav-logo">SDB</a>
                    <!-- <a href="#" class="nav-item">Gallery</a> -->
            </div>
              
            <div>
                <a href="#" class="login nav-item" data-bs-toggle="modal" data-bs-target="#loginModal"><i class="fas fa-sign-in-alt" style="margin-right: 0.4rem;"></i>Iniciar sesion</a>
                <a href="#pnr-enquiry" class="pnr nav-item">Reservación</a>
            </div>
        </nav>
    </header>
    <!-- Login Modal -->
        ...
        <section id="info-num">
            ...
            <figure>
                ...
                <figcaption>
                    ...
                    <span class="icon-name">Pasajeros</span>
                </figcaption>
            </figure>
            <figure>
                <img src="assets/img/ticket.svg" alt="Instant Ticket Icon" width="100px" height="100px">
                <figcaption>
                    <span class="num counter" data-target="<?php echo count($bookingData); ?>">999</span>
                    <span class="icon-name">Reservas</span>
                </figcaption>
            </figure>
        </section>
        <section id="pnr-enquiry">
            <div id="pnr-form">
                ...
                <form action="<?php echo $_SERVER["REQUEST_URI"]; ?>" method="POST">
                    <div>
                        <input type="text" name="pnr" id="pnr" placeholder="Ingrese código">
                    </div>
                    <button type="submit" name="pnr-search">Buscar</button>
                </form>
            </div>
        </section>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <p>
                ¿Realmente quieres eliminar tu reserva? <strong>Esta acción no se podra deshacer.</strong>
            </p>
            <!-- Needed to pass pnr -->
      ...
      <div class="modal-footer">
        <button type="submit" form="delete-form" class="btn btn-primary btn-danger" name="deleteBtn">Eliminar</button>
      </div>
    </div>
  </div>
</div>
